...
bool_comparative_dict = {
    'da': {
        'true_list': ["Sandt", "Rigtig", "Rigtigt", "Korrekt", "Ja"],
        'false_list': ["Falsk", "Forkert", "Nej"],
        'after': "Efter",
        'before': "Før",
        'same': "Samme",
        'less': "Mindre",
...
if __name__ == "__main__":
    ...
    output_file = "hits_" + lang + ".json"

    with open(output_file, "w", encoding="utf-8") as json_file:
        json.dump(hits_object, json_file, ensure_ascii=False, indent=4)