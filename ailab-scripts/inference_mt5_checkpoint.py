...
checkpoint_path = "checkpoints_" + lang + "/checkpoint_99.pt"  # Path to Accelerate checkpoint
...
pre_prompt = "Svar på det følgende spørgsmål og giv en confidence score for svaret:\n Spørgsmål:"
post_prompt = "\nSvar: " 


prompts = [pre_prompt + entry['question'] + post_prompt for entry in local_question_answer]
